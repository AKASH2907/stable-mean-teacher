...
from models.aux_networks.networks_other import init_weights
from models.aux_networks.utils import UnetConv3, UnetUp3, UnetUp3_CT
...
class unet_3D(nn.Module):
    ...
    def __init__(self, feature_scale=4, n_classes=21, is_deconv=True, in_channels=3, is_batchnorm=True):
        ...
        self.center = UnetConv3(filters[2], filters[3], self.is_batchnorm, kernel_size=(
            3, 3, 3), padding_size=(1, 1, 1))
...
if __name__=="__main__":
    ...
    # print(model)
    inp = torch.randn(8, 1, 8, 224, 224).cuda()
    print(inp.shape)
    ...
    import cv2
    cv2.imwrite('seg.png', (img*255).astype(np.uint8))
