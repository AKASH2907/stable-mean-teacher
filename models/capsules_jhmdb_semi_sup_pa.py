...
class CapsNet(nn.Module):
    ...
    def forward(self, img, classification, concat_labels, epoch, thresh_ep):
        ...
        # clone to assign diffeent id blocks for each
        ...
        # print(concat_labels)
        # print(poses.shape)
        # print(feat_shape.shape, activations.shape, actor_prediction.shape)
        # print(id(actor_prediction), id(activations), id(feat_shape))
        # exit()
