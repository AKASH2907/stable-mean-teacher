...
if __name__ == '__main__':
    ...
    # sup_aug_list = ['random_crop']
    dataset = UCF101DataLoader('train', [224, 224], 8, file_id='train_annots_90_labeled_random.pkl',
                               use_random_start_frame=False)

    train_dataloader = DataLoader(dataset, batch_size=8, shuffle=True, collate_fn=collate_fn_train)
    print(len(train_dataloader))
    # exit()
    save_path = 'dataloader_viz/spatial_augments_only/'
